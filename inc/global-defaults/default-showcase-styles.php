...
define( 'GFBS_DEFAULT_SHOWCASE_HEIGHT', '600px' );
...
define( 'GFBS_DEFAULT_TAGLINE_FONT_SIZE', '32px' );
define( 'GFBS_DEFAULT_TAGLINE_FONT_WEIGHT', '700' );
define( 'GFBS_DEFAULT_TAGLINE_LETTER_SPACING', '0px' );
...
define( 'GFBS_DEFAULT_CTA_BUTTON_FONT_SIZE', '20px' );
define( 'GFBS_DEFAULT_CTA_BUTTON_FONT_WEIGHT', '700' );
define( 'GFBS_DEFAULT_CTA_BUTTON_LETTER_SPACING', '0px' );
