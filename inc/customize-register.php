...
function gfbs_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_panel( 'gfbs_globals_subpanel', array(
        ...
        'panel'     =>      'gfbs_main_panel'
            ...
            require_once get_template_directory() . '/inc/customizer/customizer-general-page-settings-section.php';

            //colors 
            require_once get_template_directory() . '/inc/customizer/customizer-colors-section.php';

            //h1 
            require_once get_template_directory() . '/inc/customizer/customizer-h1-section.php';
            //h2
            require_once get_template_directory() . '/inc/customizer/customizer-h2-section.php';
            //h3
            require_once get_template_directory() . '/inc/customizer/customizer-h3-section.php';
            //h4 
            require_once get_template_directory() . '/inc/customizer/customizer-h4-section.php';
            //h5 
            require_once get_template_directory() . '/inc/customizer/customizer-h5-section.php';
            //h6 
            require_once get_template_directory() . '/inc/customizer/customizer-h6-section.php';
            //p 
            require_once get_template_directory() . '/inc/customizer/customizer-p-section.php';
